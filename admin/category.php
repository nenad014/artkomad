                                        ...
                                        <table class="table table-hover table-striped table-bordered">
                                            ...
                                            <?php foreach($categories as $single) : ?>
                                                <tr>   
                                                    ...
                                                    <td><a href="update-category.php?cat_id=<?php echo $single->cat_id; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a> <a href="remove.php?cat_id=<?php echo $single->cat_id; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
                                        </table>
